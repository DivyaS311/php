    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="upload.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i>upload</a>
            </li>
            <li class="bold"><a href="../index.html" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i>Home</a>
            </li>
                <li class="no-padding">
